...
const projects: PortfolioItem[] = [
    {
        ...
        link: <>
            <p className="card-text">
                If you have any questions, suggestions and ideas, or get know about my other projects - feel free to contact me!
            </p>
            <a href="mailto:joanna.hulek@gmail.com?&subject=E-mail%20from%20website&body=Hi%20Joanna,%20" aria-label="mailto" className="card-link">E-mail</a>
    ...
    },
    {
        ...
        description:
            <div className="row">
                <div className="col">
                    <a href="https://marka-tekst.vercel.app/" target="_blank" className="card-link">
                        <ImageCarousel
                            images={MarkaImages}
        ...
        link: <>
            <a href="https://marka-tekst.vercel.app/" target="_blank" className="card-link">Website</a>
            <a href="https://github.com/joannahulek/marka" target="_blank" className="card-link">Repository</a>
        </>
    },
    {
